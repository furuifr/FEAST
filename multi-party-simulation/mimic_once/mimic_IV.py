...
if __name__ == '__main__':
    ...
    for sub_col_num in range(1, new_col_num+1):
        ...
        acc_res_fl_ratio_logi.append(clf_cv('logi', data_sum_fl_ratio.copy().T.drop_duplicates().T, target, RANDOMSEED))
        acc_res_fl_ratio_svc.append(clf_cv('svc', data_sum_fl_ratio.copy().T.drop_duplicates().T, target, RANDOMSEED))
        acc_res_fl_ratio_rfc.append(clf_cv('rfc', data_sum_fl_ratio.copy().T.drop_duplicates().T, target, RANDOMSEED))
        acc_res_fl_ratio_xgbc.append(clf_cv('xgbc', data_sum_fl_ratio.copy().T.drop_duplicates().T, target, RANDOMSEED))
