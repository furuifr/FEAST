...
if __name__ == '__main__':
    ...
    with open('single-party/physionet/physionet_param.yaml', 'r') as f:
    ...
    method = '_SU_'
    featureSelection(len(a_col)+new_col_num, data, data_dsct, target, method, dataset_name, dsct_method, all_columns)